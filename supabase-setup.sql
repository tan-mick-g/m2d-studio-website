...
create table if not exists public.contact_submissions (
  ...
  recipient_email text not null default 'marketing@madetodance.ph',
  source_path text,
  user_agent text,
...
drop policy if exists "Anyone can send contact submissions" on public.contact_submissions;
create policy "Anyone can send contact submissions"
...
drop policy if exists "Only listed admins can read contact submissions" on public.contact_submissions;
create policy "Only listed admins can read contact submissions"
on public.contact_submissions
for select
to authenticated
using (public.is_site_admin());

drop policy if exists "Only listed admins can update contact submissions" on public.contact_submissions;
create policy "Only listed admins can update contact submissions"
on public.contact_submissions
for update
to authenticated
using (public.is_site_admin())
...
drop policy if exists "Only listed admins can delete contact submissions" on public.contact_submissions;
create policy "Only listed admins can delete contact submissions"
on public.contact_submissions
for delete
to authenticated
using (public.is_site_admin());
